...
public class ManagerDAO extends HibernateDaoSupport {
	...
	public Manager findById(java.lang.Integer id) {
		...
		try {
			Manager instance = (Manager) getHibernateTemplate().get("com.xxxxxx.Manager", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Manager instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Manager as model where model." + propertyName + "= ?";
