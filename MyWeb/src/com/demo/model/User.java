...
public class User implements java.io.Serializable {
	...
	/** full constructor */
	public User(Integer userId, Manager manager, String userName, String usrPsw, String sex, String tel, String emial,
			String iconUrl, String resume, Timestamp registetime, Timestamp firstLoginTime, Timestamp lastLoginTime,
			Boolean isContributor, Boolean isSponsor, Set campaigns) {
		this.userId = userId;
